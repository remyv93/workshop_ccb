...
To set your GBIF account in RStudio please open RStudio and copy/run the following code. Make sure to have installed the package ***'usethis'*** in section1.
...
1- Create a folder in your desktop named Purdue workshop
